...
{% if site.search.enabled %}<link rel="stylesheet" href="http://static.voog.com/libs/edicy-search/1.0.0/edicy-search.css">{% endif %}
{% if editmode %}<link rel="stylesheet" href="/assets/admin/tools/0.1.2/edicy-tools.css">{% endif %}
