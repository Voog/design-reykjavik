:root {
  /* VoogStyle
    ...
    "featured": true
  */
  --blog-article-title-font-size: 70px;
  /* VoogStyle
     "pathI18n": ["blog", "title"],
     ...
     "scope": "global"
  */
  --blog-article-title-line-height: 1.2;
  /* VoogStyle
     "pathI18n": ["blog", "title"],
     "titleI18n": "alignment",
     "editor": "listPicker",
     ...
     "scope": "global"
  */
  --blog-article-title-alignment: center;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
    ...
    "scope": "global"
  */
  --blog-article-title-font-weight: 600;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
    ...
    "scope": "global"
  */
  --blog-article-title-font-style: normal;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
    ...
    "scope": "global"
  */
  --blog-article-title-text-decoration: none;
  /* VoogStyle
    "pathI18n": ["blog", "title"],
    ...
    "scope": "global"
  */
  --blog-article-title-text-transform: none;
  /* VoogStyle
    "pathI18n": ["blog", "date"],
    "titleI18n": "size",
    "editor": "rangePicker",
    ...
    "featured": true
  */
  --blog-article-date-font-size: 23px;
  /* VoogStyle
     "pathI18n": ["blog", "date"],
     "titleI18n": "line_height",
     "editor": "rangePicker",
     ...
     "scope": "global"
  */
  --blog-article-date-line-height: 1.2;
  /* VoogStyle
    "pathI18n": ["blog", "date"],
    "titleI18n": "font_weight",
    "type": "button",
    ...
    "scope": "global"
  */
  --blog-article-date-font-weight: 400;
  /* VoogStyle
    "pathI18n": ["blog", "date"],
    "titleI18n": "font_style",
    "type": "button",
    ...
    "scope": "global"
  */
  --blog-article-date-font-style: normal;
  /* VoogStyle
    "pathI18n": ["blog", "date"],
    "titleI18n": "text_decoration",
    "type": "button",
    ...
    "scope": "global"
  */
  --blog-article-date-text-decoration: none;
  /* VoogStyle
    "pathI18n": ["blog", "date"],
    "titleI18n": "text_transform",
    "type": "button",
    ...
    "scope": "global"
  */
  --blog-article-date-text-transform: none;
  /* VoogStyle
    "pathI18n": ["blog", "text"],
    "titleI18n": "size",
    "editor": "rangePicker",
